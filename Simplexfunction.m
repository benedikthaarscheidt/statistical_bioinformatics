...
A = [ 2  1  1  0  0;  % Coefficients for the first constraint: 2x1 + x2 + s1 = 18
      2  2  0  1  0;  % Coefficients for the second constraint: 2x1 + 2x2 + s2 = 42
      3  1  0  0  1]; % Coefficients for the third constraint: 3x1 + x2 + s3 = 24
b = [18; 42; 24];

c = [-3; -2; 0; 0; 0];  % Coefficients of the objective function: -3x1 -2x2


tab = nma_simplex(A, b, c, true);  % Call the simplex method with debugging
